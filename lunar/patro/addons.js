...
function get_bs_date_detail(bs_year, bs_month, bs_date) {
  ...
  if (bs_year >= 2080 && bs_year <= 2080) {
    json_url = 'https://bhaishrayeshdahal.github.io/shrayesh-dahal/data/' + bs_year + '_detailed.json';
  }
  else if (bs_year >= 2070 && bs_year <= 2075) {
    json_url = 'https://bhaishrayeshdahal.github.io/shrayesh-dahal/data/' + bs_year + '.json';
  }
  else {
    return '{}';
  }
